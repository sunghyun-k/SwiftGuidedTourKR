//: ## 객체와 클래스
//:
//: 클래스를 생성하려면 `class` 뒤에 클래스의 이름을 작성하십시오. 클래스의 속성 선언은 클래스의 문맥 안에 있다는 점을 제외하고는 상수 또는 변수의 선언과 같은 방법으로 작성됩니다. 마찬가지로 메소드도 함수 선언과 같은 방식으로 작성하면 됩니다.
//:
class Shape {
    var numberOfSides = 0
...
//: - Experiment:
//: `let`을 사용하여 상수 속성을 추가하십시오. 그리고 인자를 받는 메소드를 하나 더 추가해보십시오.
//:
